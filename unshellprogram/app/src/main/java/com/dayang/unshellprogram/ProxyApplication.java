package com.dayang.unshellprogram;
...
public class ProxyApplication extends Application  {
    ...
    protected void attachBaseContext(Context base) {
        ...
        try {
            ...
            Log.d(TAG, "hello world~packageName="+packageName);
    ...
    public void onCreate() {
        super.onCreate();
        {
            ...
            if(null == app){
                Log.d(TAG, "application get is null !");
            }else {
                app.onCreate();
            }
        }
    ...
    private void splitPayLoadFromDex(byte[] data) throws IOException {
        ...
        while (true) {
            ...
            //Log.d(TAG, "localZipEntry.getName()="+name);
            if (name.startsWith("lib/") && name.contains("armeabi-v7a") && name.endsWith(".so")) {
                File storeFile = new File(libPath + "/"
                        + name.substring(name.lastIndexOf('/')));
                Log.d(TAG, "storeFile.name()="+libPath + "/"
                        + name.substring(name.lastIndexOf('/')));
                Log.d(TAG, "storeFile.getAbsolutePath()="+storeFile.getAbsolutePath());
